...
public class TargetManager {
	...
	private static List<LivingEntity> areaTarget(TargetDetails t){
		...
		World w = Bukkit.getWorld(MineQuest.questManager.getQuest(t.getQuest()).getWorld());
	...
	private static List<LivingEntity> areaTargetQuester(TargetDetails t){
		...
		List<LivingEntity> es = getTarget(MineQuest.questManager.getQuest(t.getQuest()).getTarget(targetID));
